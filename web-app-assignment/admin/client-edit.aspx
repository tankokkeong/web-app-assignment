<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="client-edit.aspx.cs" Inherits="web_app_assignment.admin.client_edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="details-container">
        <div class="details-header mb-3">
            <h2>Client - Job Seeker Status</h2>
        </div>
