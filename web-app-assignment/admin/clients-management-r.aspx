    ...
    <form runat="server">
        <div class="clients-container">
            ...
            <div class="table-container">
                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging="GridView3_PageIndexChanging" PageSize="10" CssClass="table table-striped table-bordered">
