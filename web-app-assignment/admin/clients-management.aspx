    ...
    <form runat="server">
        <div class="clients-container">
            ...
            <div class="table-container">
                <asp:GridView ID="GridView2" runat="server" AllowPaging="True"  PageSize="2" AutoGenerateColumns="False" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" CssClass="table table-striped table-bordered">
                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    <tr>
                                        <td>User Status</td>
                                        <td>
                                            <asp:DropDownList ID="UserStatus" class="form-control" AutoPostBack="True" runat="server">
